                            ...
                            <article className="">
                                <div className="entry-content">
                                    <div className="woocommerce">
                                        ...
                                        <form className="woocommerce-cart-form text-align-center"
                                            action="#" method="post">
                                            <table className="shop_table shop_table_responsive col-md-12 woocommerce-cart-form__contents" cellspacing="0">
                                                ...
                                                <tbody className="shop_table_body">
                                                    <tr className="woocommerce-cart-form__cart-item cart_item">
                                                        <td className="product-remove">
                                                            <a href="#" className="remove" aria-label="Remove this item" data-product_id="682" data-product_sku="">&times;</a></td>
                                                        <td className="product-thumbnail">
                                                            <a href="#"><img width="162" height="300"
                                                                src="http://okthemes.com/villenoir/wp-content/uploads/2016/03/Red-Pinot-Noir-w-cup.png"
                                                                className="attachment-9999x300 size-9999x300" alt="" /></a>
                                                        </td>
                                                        <td className="product-name" data-title="Product">
                                                            <a href="#">VillenoirPinot Noir</a> </td>
                                                        <td className="product-price" data-title="Price">
                                                            <span className="woocommerce-Price-amount amount">189,00&nbsp;<span
                                                                className="woocommerce-Price-currencySymbol">&euro;</span></span>
                                                        </td>
                                                        <td className="product-quantity" data-title="Quantity">
                                                            <div className="quantity buttons_added">
                                                                <input type="button" value="-" className="minus"></input>
                                                                <label className="screen-reader-text" for="quantity_5dcb88c341594">Villenoir Pinot Noir quantity</label>
                                                                <input type="number" id="quantity_5dcb88c341594" className="input-text qty text" step="1" min="0" max value="1" title="Qty" size="4" inputmode="ntmeric"></input>
                                                    ...
                                                    <tr>
                                                        <td colspan="6" className="actions">
                                                            <div className="coupon">
                                                                <div className="input-group">
                                                                    ...
                                                                    <input type="text" name="coupon_code"
                                                                        className="input-text form-control" id="coupon_code"
                                                                        value="" />
                                                                    <span className="input-group-btn">
                                                                        <input type="submit" className="button btn btn-primary" name="apply_coupon"
                                                                            value="Apply" />
                                                                    </span>
                                                                </div>
                                                            </div>
                                                            <input type="hidden" id="_wpnonce" name="_wpnonce"
                                                                value="ccaefa2a03" />
                                                            <input type="hidden"
                                                                name="_wp_http_referer" value="/villenoir/cart/" />
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                                        ...
                                                        <ul className="products">
                                                            <li className="col-xl-6 col-xs-12 col-sm-12 col-md-12 post-686 product type-product status-publish has-post-thumbnail product_cat-white-wines member-discount discount-restricted first instock shipping-taxable purchasable product-type-simple">
                                                                <a href="#"
                                                                    ...
                                                                    <h2 className="woocommerce-loop-product__title">Villenoir Riesling</h2>
                                                                    <div className="gg-product-image-wrapper"><img width="1400"
                                                                        height="2225"
                                                                    ...
                                                                    <dl>
                                                                        ...
                                                                        <dd>
                                                                            <span className="price"><span
                                                                                className="woocommerce-Price-amount amount">165,00&nbsp;<span
                                                                                    className="woocommerce-Price-currencySymbol">&euro;</span></span></span>
                                                                        </dd>
                                                                    </dl>
                                                                    <a href="#" data-quantity="1"
                                                                        className="button product_type_simple add_to_cart_button ajax_add_to_cart"
                                                                        data-product_id="686" data-product_sku=""
                                                                        aria-label="Add &ldquo;Villenoir Riesling&rdquo; to your cart"
                                                                        rel="nofollow">Add to cart</a>
                                                                </div>
                                                            </li>
                                                            <li
                                                                className="col-xl-6 col-xs-12 col-sm-12 col-md-12 post-684 product type-product status-publish has-post-thumbnail product_cat-white-wines member-discount discount-restricted last instock shipping-taxable purchasable product-type-simple">

                                                                <a href="#"
                                                                    className="woocommerce-LoopProduct-link woocommerce-loop-product__link">
                                                                    <h2 className="woocommerce-loop-product__title">Villenoir
                                                                Chardonnay</h2>
                                                                    <div className="gg-product-image-wrapper"><img width="1400"
                                                                        height="2225"
                                                                ...
                                                                <div className="gg-product-meta-wrapper">
                                                                    <dl>
                                                                        ...
                                                                        <dd>
                                                                            <span className="price"><span
                                                                                className="woocommerce-Price-amount amount">236,00&nbsp;<span
                                                                                    className="woocommerce-Price-currencySymbol">&euro;</span></span></span>
                                                                        </dd>
                                                                    </dl>
                                                                    <a href="#" data-quantity="1"
                                                                        className="button product_type_simple add_to_cart_button ajax_add_to_cart"
                                                                        data-product_id="684" data-product_sku=""
                                                    ...
                                                    <table cellspacing="0" className="shop_table shop_table_responsive">
                                                        <tr className="cart-subtotal">
                                                            ...
                                                            <td data-title="Subtotal"><span
                                                                className="woocommerce-Price-amount amount">189,00&nbsp;<span
                                                                    className="woocommerce-Price-currencySymbol">&euro;</span></span>
                                                            </td>
                                                        </tr>
                                                                ...
                                                                <ul id="shipping_method" className="woocommerce-shipping-methods">
                                                                    <li>
                                                                        <input type="hidden" name="shipping_method[0]"
                                                                            ...
                                                                            value="flat_rate:3" className="shipping_method" /><label
                                                                                for="shipping_method_0_flat_rate3">Flat rate: <span
                                                                                    className="woocommerce-Price-amount amount">10,00&nbsp;<span
                                                                                        className="woocommerce-Price-currencySymbol">&euro;</span></span></label>
                                                                    </li>
                                                                </ul>
                                                        ...
                                                        <tr className="order-total">
                                                            ...
                                                            <td data-title="Total"><strong><span
                                                                className="woocommerce-Price-amount amount">199,00&nbsp;<span
                                                                    className="woocommerce-Price-currencySymbol">&euro;</span></span></strong>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <div className="d-flex">
                                                        <div className="wc-update-cart">
                                                            <input type="submit" className="button" name="update_cart"
                                                                value="Update cart" />
                                                        </div>
                                                        <div className="wc-proceed-to-checkout">
                                                        <Link to="/ShopingCar/Billing_details" className="checkout-button button alt wc-forward"> Proceed to checkout</Link>
                                                        </div>
                                                    </div>
