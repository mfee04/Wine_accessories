                        ...
                        <Row className="d-flex">
                            ...
                            <Col xl={6} md={4} sm>
                                <div className="M_img">
                                    ...
                                    <p className="figure_text position-relative">在1950年代開始，Aperol Spritz 在義大利開始流行起來，慢慢演化出「義大利國民飲料」的地位。在 2003 年 Aperol 被金巴利集團收購後，集團更把這調酒定位為「最適合社交場合的飲料」，並且下了不少預算贊助如 Moto GP 等賽事，營業額比起收購前爆增四倍<a href="#" className="position-absolute">Read More</a></p>
                                </div>
                            </Col>
                            <Col xl={3} sm>
                                <a href="#" className="figure">
