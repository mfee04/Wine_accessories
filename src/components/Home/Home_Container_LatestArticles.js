                            ...
                            <Col xl={6} lg className="LatestArticles_Area2">
                                <div className="M_img">
                                    ...
                                    <Col xl={12} md={7} className="text_region">
                                        ...
                                        <p className="figure_text">在1950年代開始，Aperol Spritz 在義大利開始流行起來，慢慢演化出「義大利國民飲料」的地位。在 2003 年 Aperol 被金巴利集團收購後，集團更把這調酒定位為「最適合社交場合的飲料」，並且下了不少預算贊助如 Moto GP 等賽事，營業額比起收購前爆增四倍</p>
                                        <a href="#" className="post">Read More</a>
                                    </Col>
                                </div>
                            </Col>
